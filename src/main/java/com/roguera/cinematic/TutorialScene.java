...
import com.roguera.exceptions.InterruptedSequence;
...
public class TutorialScene {
	...
	private static final Logger log = LoggerFactory.getLogger(TutorialScene.class);
	...
	public void startSequence() {
		try {
			...
			log.info("[TUTORIAL][STATUS]Tutorial skipped");
			Draw.clear();
		}
		isAction = false;
	}
